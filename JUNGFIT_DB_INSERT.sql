...
VALUES 
("Thankyou BUBU","thankyou","땅끄부부","thanku@naver.com","유튜브 구독자 300만"),
("GYM JONG KOOK","gym","짐종국","ggg@naver.com","가수 출신 트레이너"),
...
(0,'heejung','c603faf8d4ffdd36858e61931a2b064a68f49d1cfc5a8700ec905daa56fec9d5','전희정','jhj@ssafy.com','상도동',14.6951,165,40,20,0,'GYM JONG KOOK',NULL,NULL),
(0,'ddasumi','5b61e05803a307a43a2977dbf338b2b10bb4fcfff33a4d3d98c62a22558cdc44','따수미','dsm@ssafy.com','별내동',10,200,40,21,	0,'GYM JONG KOOK',NULL,NULL),
...
(0,'goonsun','ce7b287dfff291a22f9ecd23b93febdf5c3947cd63effc224436bb163dde040b','진군선','jgs@ssafy.com','마포구 무슨동',16.6205,190,60,22,0,'GYM JONG KOOK',NULL,NULL),
...
("HCnDDAMDKps","어깨후면.. 저는 이렇게 합니다..", "상체", 2678361, "GYM JONG KOOK"),
...
("8thMw9JyxBE","어깨 운동만 '한' 남자", "상체", 3763321, "GYM JONG KOOK"),
("u8u0RzwRko0","집’요한’ 상체 트레이닝... (ft. 영화 보이스)", "상체", 2865420, "GYM JONG KOOK"),
...
("IS5OA7GeBJc", "1분만에 상체살 끝장내기 1 MIN UPPER BODY&ARM FAT WORKOUT", "상체", 0, "Thankyou BUBU"),
...
("0L5gAT1fJaM","뱃살 아랫뱃살 최고의 운동", "복부", 0, "Thankyou BUBU"),
("eg_DipJ7UVk","뱃살 빠지는 최고의 운동 BEST", "복부", 0, "Thankyou BUBU"),
("MXezTFmhq9A", "걸으면서 뱃살 쭉쭉 빠지는 운동 [걸쭉빠 뱃살]", "복부", 3, "Thankyou BUBU"),
("iOSYLKBk894", "무.조.건! 뱃살 빠지는 운동 베스트5", "복부", 45, "Thankyou BUBU"),
("ZDU5n-i3fmQ", "뱃살 허벅지살 동시에 빠지는 운동 [일타쌍피 운동]", "복부", 4, "Thankyou BUBU"),
...
("u5OgcZdNbMo","저는 '하체'식주의자 입니다..", "하체", 0, "GYM JONG KOOK"),
("jDQ_42bNT-Q","의자.. 다들 보이시죠?", "하체", 0, "GYM JONG KOOK"),
("NDsjmxTROEo","하체비만 11자다리 최고의 운동 [하체 핵매운맛]", "하체", 0, "Thankyou BUBU"),
("LK9e6mg4cmQ","허벅지살 다리살 최고의 운동", "하체", 0, "Thankyou BUBU"),
...
("6R_V7Yofudg","무.조.건! 허벅지살 빠지는 운동", "하체", 0, "Thankyou BUBU"),
-- 전신 --
("Lr_Xy0t2DCU","피티(PT)기는 운동", "전신", 0, "GYM JONG KOOK"),
("gMaB-fG4u4g","전신 다이어트 최고의 운동 [칼소폭 찐 핵핵매운맛]", "전신", 0, "Thankyou BUBU"),
("YOw7EIz34QE","3분만에 전신 다이어트 끝장내기 3 MIN FULL BODY WORKOUT [Billie Eilish - bad guy]", "전신", 0, "Thankyou BUBU"),
("2LyDkE7sDec","초간단! 전신 스트레칭 끝판왕 BEST5", "전신", 0, "Thankyou BUBU"),
...
("e4WnrhXTjg8","몰디브에서 운동 한 잔..", "전신", 0, "GYM JONG KOOK"),
("5zvX5qv_HSw","제가.. 유튜브를... 시작합니다", "전신", 0, "GYM JONG KOOK");
